        ...
        <form action="" method="post" class="form label">
            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="form-content">
                        <input type="text" name="settings[smtp_email_sender]" value="<?= settings('smtp_email_sender') ?>">
                    </div>
                </li>
                <li>
                    <label>SMTP Email Sender Name</label>
                    <div class="form-content">
                        <input type="text" name="settings[smtp_email_sender_name]" value="<?= settings('smtp_email_sender_name') ?>">
                    </div>
                </li>
            </ul>
            <ul>
