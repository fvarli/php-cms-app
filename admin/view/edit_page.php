                ...
                <div tab-content>
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="form-content">
                                <textarea name="page_content" id="" cols="30" rows="10"><?=post('page_content') ? post('page_content') : $row['page_content']?></textarea>
                            </div>
                        </li>
                    </ul>
                </div>
                <div tab-content>
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="form-content">
                                <textarea name="page_seo[description]" class="editor" cols="30" rows="5"><?=$seo['description']?></textarea>
                            </div>
                        </li>
                    </ul>
                </div>
