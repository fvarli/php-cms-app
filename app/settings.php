...
$settings["facebook"] = "fvarlii";
$settings["twitter"] = "f_varli";
$settings["instagram"] = "f_varli";
$settings["linkedin"] = "fvarli";
$settings["visitor_comment"] = "1";
$settings["user_comment"] = "1";
$settings["logo_title"] = "ferzendervarli.com";
$settings["welcome_title"] = "Websiteme Hoş Geldiniz!";
$settings["welcome_content"] = "Bu web sitesi altında, yazılım ile alakalı makaleler, günlük hayat ile ilgili tecrübeler ve müzikle ilgili bazı tavsiyeler bulabilirsiniz. Kısaca kişisel bir bloğa hoşgeldiniz, keyfini çıkarın!";
$settings["search_placeholder"] = "Search here...";
$settings["theme"] = "theme-one";
